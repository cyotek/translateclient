...
{
	/// <summary>
	/// Description of SynonimyPlThesaurus.
	/// </summary>
	[SuppressMessage("Microsoft.Naming", "CA1706:ShortAcronymsShouldBeUppercase")]
	[SuppressMessage("Microsoft.Naming", "CA1711:IdentifiersShouldNotHaveIncorrectSuffix")]
	public class SynonimyPlThesaurus : SynonymsDictionary
	{
		public SynonimyPlThesaurus()
		{
			AddSupportedTranslation(Language.Polish, Language.Polish);
		...
		static Encoding encoding = Encoding.GetEncoding("iso-8859-2");
