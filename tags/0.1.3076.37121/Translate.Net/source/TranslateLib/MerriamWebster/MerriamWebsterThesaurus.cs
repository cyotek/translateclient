...
namespace Translate
{
	...
	public class MerriamWebsterThesaurus : SynonymsDictionary
	{
		...
		{
			MerriamWebsterUtils.DoTranslate(this, "http://www.merriam-webster.com/thesaurus", "Thesaurus", phrase, languagesPair, subject, result, networkSetting);
		}
