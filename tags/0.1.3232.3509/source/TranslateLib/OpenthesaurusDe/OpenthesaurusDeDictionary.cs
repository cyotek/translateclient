...
{
	/// <summary>
	/// Description of OpenthesaurusDeDictionary.
	/// </summary>
	[SuppressMessage("Microsoft.Naming", "CA1706:ShortAcronymsShouldBeUppercase")]
	[SuppressMessage("Microsoft.Naming", "CA1711:IdentifiersShouldNotHaveIncorrectSuffix")]
	public class OpenthesaurusDeDictionary : SynonymsDictionary
	{
		public OpenthesaurusDeDictionary()
		{
			AddSupportedTranslation(Language.German, Language.German);
		...
		{
			string query = "http://www.openthesaurus.de/overview.php?search=1&word={0}";
			...
			if(responseFromServer.Contains("<strong>Keine genauen Treffer in OpenThesaurus"))
			{
