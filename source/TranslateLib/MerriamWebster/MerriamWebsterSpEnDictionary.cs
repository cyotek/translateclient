...
namespace Translate
{
	...
	public class MerriamWebsterSpEnDictionary : BilingualDictionary
	{
		...
		{
			MerriamWebsterUtils.DoTranslate(this, "http://www.merriam-webster.com/spanish", "Spanish", phrase, languagesPair, subject, result, networkSetting);
		}
