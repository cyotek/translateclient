...
namespace WebUI
{
	...
	{	
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			MemoryStream iconStream = (MemoryStream)Cache[service];
			if(iconStream == null)
			{
				Icon icon = Global.WebServerGate.GetServiceIcon(service);
				if(icon == null)
				{
					Response.StatusCode = 404;
					Response.End();
			...
			iconStream.WriteTo(Response.OutputStream);
			Response.End();
