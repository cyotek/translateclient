...
namespace Translate
{
	partial class ResultViewFontOptionsControl
	{
		...
		private void InitializeComponent()
		{
			...
			// pBody
			// 
			this.pBody.Controls.Add(this.bReset);
			...
			// bReset
			// 
			this.bReset.Location = new System.Drawing.Point(14, 194);
			this.bReset.Name = "bReset";
			this.bReset.Size = new System.Drawing.Size(82, 23);
			this.bReset.TabIndex = 2;
			this.bReset.Text = "To default";
			this.bReset.UseVisualStyleBackColor = true;
			this.bReset.Click += new System.EventHandler(this.BResetClick);
			// 
			// geMain
			// 
			this.geMain.Idle += new System.EventHandler(this.GeMainIdle);
			// 
