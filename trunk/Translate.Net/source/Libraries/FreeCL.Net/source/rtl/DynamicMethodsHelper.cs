...
namespace FreeCL.RTL
{
	...
	{
		protected delegate void PropertySetter(TValue value);
		protected delegate TValue PropertyGetter();
		...
		{
			PropertyInfo property = o.GetType().GetProperty(propertyName, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
			if (property != null && (!property.CanRead || !property.CanWrite) && (property.PropertyType == typeof(TValue)))
			{
				property = null;
			} 
			return property;
	...
	public class StringPropertyWrapper : PropertyWrapper<string>	
	{
	}
