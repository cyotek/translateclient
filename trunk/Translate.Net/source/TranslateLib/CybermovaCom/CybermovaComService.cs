...
{
	/// <summary>
	/// Description of MetaUaService.
	/// </summary>
	public class CybermovaComService : Service
	{
		public CybermovaComService()
		{
			Url = new Uri("http://www.cybermova.com");
			Name = "cybermova_com";
			CompanyName = "Mykola Sazhok";
			Copyright = "Copyright © 2006, Mykola Sazhok";

			IconUrl = new Uri("http://translate-net.appspot.com/cybermova.png");
