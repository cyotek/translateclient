...
namespace Translate
{
	...
	public class DictDService : Service
	{
		public DictDService()
		{
			...
			FullName = "The Dictionary Server Protocol (DICT - RFC 2229) is a TCP transaction based query/response protocol that allows a client to access dictionary definitions from a set of natural language dictionary databases.";
