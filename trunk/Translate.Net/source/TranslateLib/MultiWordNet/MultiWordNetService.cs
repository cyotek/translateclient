...
{
	/// <summary>
	/// Description of MultiWordNetService.
	/// </summary>
	public class MultiWordNetService : Service
	{
		public MultiWordNetService()
		{
			Url = new Uri("http://multiwordnet.itc.it/english/home.php");
			Name = "multiwordnet";
