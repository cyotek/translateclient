...
namespace Translate
{
	...
	public class SaDirBgDictionary : BilingualDictionary
	{
		public SaDirBgDictionary()
		{
			AddSupportedTranslationFromEnglish(Language.Bulgarian);
			AddSupportedTranslationToEnglish(Language.Bulgarian);
