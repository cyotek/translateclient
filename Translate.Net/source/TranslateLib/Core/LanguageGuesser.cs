...
{
	/// <summary>
	/// Description of LanguageDetectorItem.
	/// </summary>
	public abstract class LanguageGuesser : BaseServiceItem
	{
		LanguageCollection supportedLanguages = new LanguageCollection();
		
		public ReadOnlyLanguageCollection SupportedLanguages
		{
			get{return new ReadOnlyLanguageCollection(supportedLanguages);}
		}
