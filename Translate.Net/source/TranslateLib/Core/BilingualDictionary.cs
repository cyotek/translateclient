...
namespace Translate
{
	...
	public class ReadOnlyBilingualDictionariesCollection: ReadOnlyCollection<BilingualDictionary>
	{
	...
	[Serializable] 
	public class LanguagePairBilingualDictionariesDictionary	 : Dictionary<LanguagePair, BilingualDictionariesCollection>
	{
		public LanguagePairBilingualDictionariesDictionary()
		{
		}
		
		protected LanguagePairBilingualDictionariesDictionary(SerializationInfo info, StreamingContext context):base(info, context)
		{
