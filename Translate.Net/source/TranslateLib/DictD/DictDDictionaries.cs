...
namespace Translate
{
	public class UrlList : List<Uri>
	{
	
	}
	
	public interface IDictDServiceItem
	{
		UrlList Urls
		{
			get;
	...
	/// <summary>
	/// Description of DictDDictionary.
	/// </summary>
	public class DictDMonolingualDictionary : MonolingualDictionary, IDictDServiceItem
	{
		public DictDMonolingualDictionary()
		{
			CharsLimit = 50;
			LinesLimit = 1;			
		}
