...
{
	/// <summary>
	/// Description of OpentaalOrgThesaurus.
	/// </summary>
	[SuppressMessage("Microsoft.Naming", "CA1706:ShortAcronymsShouldBeUppercase")]
	[SuppressMessage("Microsoft.Naming", "CA1711:IdentifiersShouldNotHaveIncorrectSuffix")]
	public class OpentaalOrgThesaurus : SynonymsDictionary
	{
		public OpentaalOrgThesaurus()
		{
		...
		{
			string query = "http://www.opentaal.org/opentaalbank/thesaurus/multimatch.php?word={0}&search=1";
